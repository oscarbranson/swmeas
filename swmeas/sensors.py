...
class pH_CO2_sensor(object):
    """
    Connect to and take measurements from a Durafit pH probe and a Gascard CO2 sensor via a LabJack U6-Pro
    ...
    def __init__(self, GainIndex=0, Differential=True):
        ...
        self.comm = {'LJTemp': u6.AIN24(14),
                     ...
                     'CO2': u6.AIN24(4, ResolutionIndex=12, GainIndex=self.gainindex, Differential=self.differential)}
    ...
    def read(self):
        ...
        bLJ_temp, bpH_temp, bpH, bCO2 = self.sensor.getFeedback(self.comm['LJTemp'], self.comm['Temp'], 
                                                                self.comm['pH'], self.comm['CO2'])
        ...
        CO2 = self.sensor.binaryToCalibratedAnalogVoltage(self.gainindex, bCO2)

        self.last_read = [tnow, pH, pH_temp, CO2, LJ_temp]

        return self.last_read

    def read_multi(self, n, wait=1.):
        """
        Read Durafit pH and Temperature voltage, Gascard CO2 voltage, and LabJack Temperature.
